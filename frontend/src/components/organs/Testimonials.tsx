    ...
    return (
        <section className="w-full h-auto flex items-center bg-zinc-950">
            <main className="w-full lg:h-[700px] md:h-[600px] flex flex-col justify-center items-center gap-10 md:gap-10 py-12 md:py-0">
                ...
                <div className="flex flex-col mt-10 items-center relative before:absolute before:-bottom-6 before:left-30 before:w-20 before:h-1 before:rounded-lg before:bg-primary z-10">
                    <Text as="p" className="text-primary lg:text-sm text-xs tracking-widest uppercase font-medium">{TestimonialTexts.firstText}</Text>
                    ...
                    <Slider {...settings}>
                        {
                            TestimonialTexts.feedBacks.map((feedback, index) => (
                                <div key={index} className="lg:px-6 md:px-4 w-full px-3">
                                    <Card className="bg-zinc-800 w-full h-[250px] grid grid-cols-3 border-[0.01rem] border-secondary">
                                        <div className="flex flex-col justify-center md:justify-start gap-1 col-span-2 lg:p-8 p-4">
                                            ...
                                            <Text as="h6" className="text-primary text-sm uppercase">{feedback.type}</Text>
                                            <Text as="p" className="mt-3 text-sm text-zinc-500">
                                                <q>{feedback.text}</q>
                                            </Text>
                                            <div className="flex mt-3 gap-2 items-center text-primary">
