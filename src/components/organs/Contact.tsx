    ...
    return (
        <section className="w-full md:h-[400px] h-[500px] relative">
            ...
            <div className="w-full h-full absolute top-0 left-0 bg-zinc-900/70 flex flex-col justify-center items-center gap-2">
                <Text as="p" className="tracking-widest text-primary uppercase md:text-sm text-xs font-medium">
                ...
                <Button className="px-10 font-medium text-black py-2.5 bg-primary whitespace-nowrap" type="button">
                    {ContactTexts.button}
                </Button>
            </div>
        </section>
